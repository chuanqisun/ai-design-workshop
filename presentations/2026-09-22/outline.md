...
Give enabled new ways of design. We need to ask whether the designer is present.

## About me

Ex-software engineer, 2nd year master. I built 50+ projects last year. I hope by the end of the workshop, you will be equipped with the knowledge to develop your own skills and tools that help you be exponentially more creative, be more human, and maybe, more than human.

## New Frontiers

Look beyond the chatbots. What are the labs building today?
...
- Generate
  ...
  - Geometric Grounding (and hallucination)
    - Void shapes demo
  - Granola Grounding
    - Demo my MIT course note
  - Self-interview or questionaire (reverse prompting)
...
- Evaluate
  - Quantification (design rubric)
    - Demo: Measure and sort
    - Demo: Semantic sort
  - Data visualization
  - Virutal prototyping
    - Demo: Time travel radio

Etymology: Curate comes from the Latin curare, meaning “to care for.”
